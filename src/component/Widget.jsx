...
const Widget = ({ widget, category }) => {
  ...
  return (
    <div className="bg-white rounded-lg w-full sm:w-[48%] lg:w-[32%] min-h-[220px] px-3 py-4 shadow-lg flex flex-col transform transition duration-300 hover:scale-105">
